...
from visualize import get_grasps, get_net, collision_detection
...
def run():
    ...
    while True:
        ...
        if key == 'q':
            ...
            # get grasps
            grasps = get_grasps(net, endpoints)
            ...
            # save grasps
            grasps.save_npy(cfgs.output_path.parent / 'grasp_candidates.npy')
