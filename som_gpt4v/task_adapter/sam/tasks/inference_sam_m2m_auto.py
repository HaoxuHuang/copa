...
def inference_sam_m2m_auto_remove_robot_arm(model, image, robot_arm_mask, interleave_ratio, if_remove_robot_arm, text_size, label_mode='1', alpha=0.1, anno_mode=['Mask']):
    t = []
