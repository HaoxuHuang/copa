...
class Visualizer:
    ...
    def _draw_number_in_mask(self, binary_mask, text, color, label_mode='1', fontsize=None):
        ...
        if text == '8':
            self.draw_text(text, (coords_x[len(coords_x)//2] + 40, coords_y[len(coords_y)//2] + 70), color=color, font_size=fontsize)
        elif text == '5':
            self.draw_text(text, (coords_x[len(coords_x)//2] + 2, coords_y[len(coords_y)//2] - 40), color=color, font_size=fontsize)
        elif text == '7':
            self.draw_text(text, (coords_x[len(coords_x)//2] + 2, coords_y[len(coords_y)//2] - 80), color=color, font_size=fontsize)
        else:
