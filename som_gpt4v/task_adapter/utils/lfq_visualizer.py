...
class Visualizer:
    ...
    def _draw_number_in_mask(self, binary_mask, text, color, label_mode='1', fontsize=None):
        ...
        if text == '1':
            print(1)
            self.draw_text(text, (coords_x[len(coords_x)//2] - 230, coords_y[len(coords_y)//2] - 90), color=color, font_size=fontsize)
        elif text == '2':
            print(2)
            self.draw_text(text, (coords_x[len(coords_x)//2] - 50, coords_y[len(coords_y)//2] + 40), color=color, font_size=fontsize)
        elif text == '3':
            print(3)
            self.draw_text(text, (coords_x[len(coords_x)//2] - 50, coords_y[len(coords_y)//2] - 100), color=color, font_size=fontsize)
        else:
